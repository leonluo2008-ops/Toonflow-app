      ...
      initData: async (knex) => {
        await knex("o_agentDeploy").insert([
          ...
          },
          {
            ...
            name: "剧本Agent:决策层（短剧/剧本创作共用）",
            desc: "短剧创作加载 script_agent_decision.md，剧本创作加载 story_creator_decision.md",
            temperature: 1,
            maxOutputTokens: 0,
            disabled: false,
          },
          {
            ...
            name: "剧本Agent:监督层（短剧/剧本创作共用）",
            desc: "短剧创作加载 script_agent_supervision.md，剧本创作加载 story_creator_supervision.md",
            temperature: 1,
            maxOutputTokens: 0,
            disabled: false,
          },
          {
            ...
            name: "剧本Agent:故事骨架（短剧/剧本创作共用）",
            desc: "短剧创作加载 script_execution_skeleton.md，剧本创作加载 story_creator_l0l2.md（L0-L2架构）",
            temperature: 1,
            maxOutputTokens: 0,
            disabled: false,
          },
          {
            ...
            name: "剧本Agent:改编策略（短剧/剧本创作共用）",
            desc: "短剧创作加载 script_execution_adaptation.md，剧本创作加载 story_creator_l3.md（分章大纲）",
            temperature: 1,
            maxOutputTokens: 0,
            disabled: false,
          },
          {
            ...
            name: "剧本Agent:剧本生成（短剧/剧本创作共用）",
            desc: "短剧创作加载 script_execution_script.md，剧本创作加载 story_creator_draft.md（逐章写作）",
            temperature: 1,
            maxOutputTokens: 0,
            disabled: false,
          },
